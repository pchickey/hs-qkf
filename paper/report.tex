...
These functions might be the weakest point of comparison to Matlab, as they're quite verbose in order to fully customize the graph before plotting. There is also a library bug which prevents plots from being labeled. This part of the environment could be improved in the future.
...
plotQuaternions walks filters =
  ...
  in plotListsStyle [ Title "Quat Components" ]
                   {- , Key (Just [ "Input qre","Output qre"
                                , "Input qx","Output qx"
                                , "Input qy","Output qy"
                                , "Input qz","Output qz"]) -- Gnuplot Interface Broken? -}
