...
8$g$ and 16 bits of resolution. The maximum sample rate is 120 samples per second.

The three-axis magnetometer has 16 bits of resolution. The maximum sample rate is 75 samples per second. 
...
\begin{figure}
	\centering
	\subfloat[Top view]{\includegraphics[width=0.5\textwidth]{sensor-top.JPG}}
	\subfloat[Bottom view]{\includegraphics[width=0.5\textwidth]{sensor-bottom.JPG}}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{./plots/statictest.png}
	\caption{A unit step test. Straight lines are the input state. Converges almost instantly.}
	\label{fig:statictest}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{./plots/velocitytest-quat.png}
	\caption{A unit ramp test. At rest for $t = [0,9]$. Constant angular velocity for $t = [10,39]$. At rest from $t = [40,50]$. Solid lines are input state, dotted lines are estimated state. Plot of quaternion components.} 
	\label{fig:velocitytest-quat}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{./plots/velocitytest-eulers.png}
	\caption{Identical test to \ref{fig:velocitytest-quat}. Plot of Euler angles.}
	\label{fig:velocitytest-eulers}
\end{figure}
\subsection{Tests with Sensor}
\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{./youtube-screenshot.png}
	\caption{A still from video of an OpenGL demonstration of the sensor. Video available at \texttt{http://bit.ly/pch-qkf-video}}
	\label{fig:sensoryoutube}
\end{figure}
